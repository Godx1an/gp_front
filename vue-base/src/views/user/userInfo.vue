...
export default {
    ...
    setup() {
        ...
        const submitEdit = async (v, type) => {
            ...
            try {
                if (type === 'nickname') {
                    url = 'http://localhost:8080/user/modify_nickname';
                    data = { nickname: v };
                } else if (type === 'school') {
...
<template>
    <div class="profile-container">
        ...
        <el-descriptions :column="1" :size="size" border class="description-container">
            ...
            <template v-if="resp.next_update_time !== '0001-01-01T00:00:00Z'">
                <el-descriptions-item>
                    <template #label>
                        <div class="cell-item">
                            <el-icon :style="iconStyle">
                            ...
                            Next update school time
                        </div>
                    </template>
                    {{ formatDate(resp.next_update_time) }}
                </el-descriptions-item>
            </template>
