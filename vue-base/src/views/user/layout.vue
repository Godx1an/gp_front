...
const infodata = async () => {
    ...
    try {
        const response = await axios.post("http://localhost:8080/user/user_info", {});
...
const modifyAvatar = () => {
    router.push('/user/user1');
};

const modifyPwd = () => {
    router.push('/user/user2');
};
    ...
    <el-container class="layout-container">
        ...
        <el-aside width="200px">
            ...
            <el-menu :default-active="activePath" active-text-color="#ffd04b" background-color="#232323"
                ...
                <el-menu-item index="/item/userItemInfo">
                    <el-icon>
                        <Management />
                    </el-icon>
                    <span>选择项目</span>
                </el-menu-item>
                <el-menu-item index="/item/userItem1">
                    <el-icon>
                        <Promotion />
                    </el-icon>
                    <span>文章管理</span>
                ...
                <el-sub-menu index="user">
                    ...
                    <el-menu-item index="/user/user1">
                        <el-icon>
                            <Crop />
                        </el-icon>
                        <span>更换头像</span>
                    </el-menu-item>
                    <el-menu-item index="/user/user2">
                        <el-icon>
                            <EditPen />
                        </el-icon>
                        <span>重置密码</span>
