    ...
    <el-container class="layout-container">
        ...
        <el-aside width="200px">
            ...
            <el-menu :default-active="activePath" active-text-color="#ffd04b" background-color="#232323"
                ...
                <el-menu-item index="/superAdmin/addItem">
                    <el-icon>
                        <Management />
                    </el-icon>
                    <span>项目处理</span>
                </el-menu-item>
                <el-menu-item index="/superAdmin/addSchool">
                    <el-icon>
                        <Promotion />
                    </el-icon>
                    <span>学校处理</span>
                </el-menu-item>
                <el-sub-menu index="/superAdminInfo">
                    <template #title>
                        <el-icon>
                            <UserFilled />
                        </el-icon>
                    ...
                    <el-menu-item index="/superAdmin/superAdminInfo">
                        <el-icon>
                            <User />
                        </el-icon>
                        <span>基本资料</span>
